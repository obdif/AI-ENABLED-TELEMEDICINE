...
const CreatePatientModal = ({ isOpen, setIsOpen }) => {
        ...
        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
          <div>
            ...
            <input
              ...
              className={`mt-1 w-full px-4 lowercase py-2 border ${errors.username ? "border-red-300" : "border-gray-300"
          ...
          <div>
            ...
            <input
              ...
              className={`mt-1 w-full px-4 py-2 lowercase border ${errors.email ? "border-red-300" : "border-gray-300"
                } rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-700`}
              disabled={isLoading}
